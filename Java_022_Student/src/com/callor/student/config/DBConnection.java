...
public class DBConnection {
	...
	static {
		DataSource dataSource = new PooledDataSource(DBContract.JDBC_DRIVER, DBContract.DB_URL, DBContract.USER_NAME,
				DBContract.PASSWORD);
		...
		// 각 method의 return type를 참조하여 DBMS를 핸들링하는 CRUD 코드를
		// 생성하게 된다.
