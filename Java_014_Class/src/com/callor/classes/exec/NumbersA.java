...
public class NumbersA {
	...
	public static void main(String[] args) {
		...
		intNum1 = num1; // int type 의 데이터를 Integer type 의 변수에 저장
		
		/*
		 * primitive(기본형) 변수에 저장된 데이터를
		 * wrapper(참조형) 변수에 저장하는 순간 확장된 기능을 사용할 수 있다.
		 * 기본형 변수에 저장된 데이터를 참조형 변수에 저자하는 것
		 * box 에 기본형 변수를 담는 것과 유사해서 boxing 이라고한다.
		 * 
		 * Wrapper 클래스에 저장된 데이터를 기본형 변수에 저장하는 것을
		 * unboxing(박스 해제) 이라고 한다.
		 */
