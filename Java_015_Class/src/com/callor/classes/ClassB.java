 ...
 * 
 * ClassB 에는 아무런 method도 정의되지 않았음에도
 * ClassA 를 상속받아서 마치 ClassA의 method(2개의 add) 들이
 * 정의되어 있는 것처럼 사용이 가능하다.
 * 
 * 객체지향(OOP) 프로그래밍에서 클래스를 상속받기
 * 기존에 잘 만들어진 클래스 코드가 있으면, 그 클래스 코드를
 * 내가 만든 클래스에서 사용하고 싶을때
 * ClassA 는 매우 잘만들어진 클래스라고 하자
 * ClassB 는 ClassA 의 method 들을 그대로 물려받아 사용할 수 있다.
 * 만약 원래 ClassA 개발자가 코드를 Upgrade 하면 ClassB 도 같이
...
public class ClassB extends ClassA {
	...
	public String toString() {
		return "나는 원래 toString() method를 재 정의 한것이다.";
	}
