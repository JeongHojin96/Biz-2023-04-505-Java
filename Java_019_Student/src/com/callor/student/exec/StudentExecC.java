...
public class StudentExecC {
	...
	/*
	 * StudentServiceImplV1 클래스를 작성하는 개발자가 테스를 위해
	 * 작성하는 코드
	 * 
	 * ImplV1 클래스에는 insertStudent() 라는 method를 작성했다
	 * 하지만, StudentService interface 에는 insertStudent() method 가 없다.
	 * 
	 * 1. Service interface 에 insertStudent() method 를 추가해 주기를 팀장에게 요청하기
	 * 이 상황이 발생하면 사전에 팀원들간의 업무 조율이 명확하게 이루어지고
	 * 모든 팀원이 공감한다면 상관없다
	 * 실제 상황에서는 이러한 문제가 발생하면 프로젝트 전체에 영향을 미치게된다.
	 * 
	 * 단, 계속해서 이 프로젝트에서 insertStudnet() method를 계속 사용할
	 * 예정이라면 이 방법이 최선이다.
	...
	public static void main(String[] args) {
		 ...
		 * 이러한 상황에서 insertStudent() method를 테스트 하기위하여
